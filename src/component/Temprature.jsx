// we have used heroicons for icon
// we have used tailwind and for progress bar also tailwind tamplate
    ...
    return (
        <>
            <div className='flex justify-between'>
                ...
                />
                <div className="m-4">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-6 h-6 text-slate-200 text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer">
            ...
            <div className="flex justify-center items-center text-slate-300 mt-8 mr-8 text-[25px] text-slate-200 text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer">
                {stats.condition}
            </div>
